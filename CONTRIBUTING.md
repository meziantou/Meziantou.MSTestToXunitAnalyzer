...
Please read these guidelines before contributing to meziantou/Meziantou.MSTestToXunitAnalyzer:
...
If you have questions about how to use meziantou/Meziantou.MSTestToXunitAnalyzer, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.MSTestToXunitAnalyzer's existing code formatting and naming standard
- Run meziantou/Meziantou.MSTestToXunitAnalyzer's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.MSTestToXunitAnalyzer you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
